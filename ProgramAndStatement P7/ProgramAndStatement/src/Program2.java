...
public class Program2 extends ProgramSecondary {
    ...
    private void createNewRep() {
        //Create new empty program with the initial name "Unnamed"
    ...
    public final Map<String, Statement> newContext() {
        //Return a new instance of this.context
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        //Create temporary map of the same type as this
        Map<String, Statement> temp = this.newContext();
        //Transfer the incoming map to the temporary map
        temp.transferFrom(c);
        //Transfer this.context to the incoming map
        c.transferFrom(this.context);
        //Transfer the temporary map to this.context
        this.context.transferFrom(temp);
    }

    @Override
    public final Statement newBody() {
        //Return a new instance of this.body
    ...
    public final void swapBody(Statement b) {
        ...
        //Create temporary statement of the same type as this
        Statement temp = this.newBody();
        //Transfer the incoming statement to the temporary statement
        temp.transferFrom(b);
        //Transfer this.body to the incoming statement
        b.transferFrom(this.body);
        //Transfer the temporary statement to this.body
